...
(function () {
  ...
  var I18N = {
    en: {
      ...
      flowIntro: "Once it’s set up, using it takes just three steps — all by chatting:",
      flow1t: "Hand it your stuff",
      flow1d: "A piece of text, a list, a file, or just a topic",
      flow2t: "Answer a few questions",
      flow2d: "Pick the layout and style you want",
      flow3t: "Get a pretty web page",
      flow3d: "A single file — opens anywhere, easy to share",
    ...
    zh: {
      ...
      flowTitle: "運作流程",
      flowIntro: "裝好之後,用起來就三步,全程用聊天完成:",
      flow1t: "丟給它資料",
      flow1d: "一段文字、一份清單、一個檔案,或一個主題",
      flow2t: "回答幾個小問題",
      flow2d: "選你想要的版型和風格",
      flow3t: "拿到漂亮網頁",
      flow3d: "就是一個檔案,到處都能打開、好分享",
      howTitle: "如何使用?",
